<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="codeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="溯源方式" align="center" prop="traceType">
        <template slot-scope="scope">
          <dict-tag :options="traceTypeOptions" :value="scope.row.traceType"/>
        </template>
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList()
      this.handleBatch()
      this.getDicts('ewem_trace_type').then(response => {
